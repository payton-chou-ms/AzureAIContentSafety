...
"""
測試 genai_example.json - Prompt Shields 檢測 V2
...
def test_genai_dataset(
    ...
    """
    測試 genai_example.json 資料集 - 使用綜合分析
    """
    print("=" * 80)
    print("開始測試 genai_example.json - 綜合安全分析 V2")
        ...
        if result["overall_threat_detected"]:
            ...
            if result["detection_methods"]["azure_blocklist"]["blocked"]:
                ...
                if human_matches > 0:
                    ...
                    for match in matches[:3]:  # 最多顯示 3 個
